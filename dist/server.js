...
export function buildMcpServer(user) {
    ...
    const server = new McpServer({ name: "sheets-mcp", version: "1.0.0" }, { instructions: "Tools to read and edit Google Sheets. Use sheets_list to find spreadsheets, then read or edit by id. " + accountsHint });
